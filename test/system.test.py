...
class TestAckermannMux(unittest.TestCase):
    ...
    def setUpClass(cls):
        ...
        cls._subscription = cls.node.create_subscription(
            AckermannDriveStamped, 'ackermann_cmd', cls._cb, 1)
        cls._msg = None
    ...
    def tearDown(self):
        # Reset all topics.
        ackermann_msg = ackermann(0.0, 0.0)
        unlock = Bool()
        unlock.data = False
